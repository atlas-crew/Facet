      ...
      >
        ...
        >
          ...
          <button
            ...
            onClick={onClose}
            aria-label="Close paste job description dialog"
          >
            <X size={16} />
          </button>
        </div>
        ...
        <p style={{ fontSize: 13, color: 'var(--text-secondary)', marginBottom: 'var(--space-4)' }}>
          Paste the raw text of a job posting (e.g. from LinkedIn). We'll try to extract the
          company, role, and compensation automatically.
        </p>
