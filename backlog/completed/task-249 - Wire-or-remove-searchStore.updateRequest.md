...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [x] #1 Decision recorded: wire (in-place edit), wire (revision/fork), or remove
...
- [x] #5 Audit finding W-4 updated to resolved
<!-- AC:END -->
...
Removed the unwired searchStore API for TASK-249 via the append-only search history decision, updated test coverage/docs, and verified with focused tests, lint, typecheck, grep, and independent review.
