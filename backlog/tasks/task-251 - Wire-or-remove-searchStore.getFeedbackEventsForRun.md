...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [x] #1 Decision recorded: wire (per-run feedback display) or remove, paired with W-5
...
- [x] #5 Audit finding W-6 updated to resolved
<!-- AC:END -->
...
Removed the unwired searchStore API for TASK-251 via the append-only search history decision, updated test coverage/docs, and verified with focused tests, lint, typecheck, grep, and independent review.
